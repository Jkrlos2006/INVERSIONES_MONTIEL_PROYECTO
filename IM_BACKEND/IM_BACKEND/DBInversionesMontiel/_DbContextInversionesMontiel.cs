...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Cliente>(entity =>
        {
            ...
            entity.HasOne(d => d.Documento).WithMany(p => p.Clientes).HasConstraintName("FK__cliente__documen__7F2BE32F");
        });
        ...
        modelBuilder.Entity<Egreso>(entity =>
        {
            ...
            entity.HasOne(d => d.ClienteNavigation).WithMany(p => p.Egresos).HasConstraintName("FK_egreso_cliente");

            entity.HasOne(d => d.Comprobante).WithMany(p => p.Egresos).HasConstraintName("FK_egreso_tipoComprobante");

            entity.HasOne(d => d.ProductoNavigation).WithMany(p => p.Egresos).HasConstraintName("FK_egreso_producto");

            entity.HasOne(d => d.UsuarioNavigation).WithMany(p => p.Egresos).HasConstraintName("FK_egreso_usuario");
        });
        ...
        modelBuilder.Entity<Ingreso>(entity =>
        {
            ...
            entity.HasOne(d => d.Comprobante).WithMany(p => p.Ingresos).HasConstraintName("FK_ingresoProductos_tipoComprobante");
        ...
        modelBuilder.Entity<Proveedor>(entity =>
        {
            ...
            entity.HasOne(d => d.Documento).WithMany(p => p.Proveedors).HasConstraintName("FK__proveedor__docum__7E37BEF6");
        });
        ...
        modelBuilder.Entity<Usuario>(entity =>
        {
            ...
            entity.HasOne(d => d.Perfil).WithMany(p => p.Usuarios).HasConstraintName("FK__usuario__perfil___7D439ABD");
        });
